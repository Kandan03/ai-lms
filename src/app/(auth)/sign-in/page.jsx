            ...
            <form className="flex flex-col gap-6">
              ...
              <div className="grid gap-6">
                <div className="grid gap-3">
                  ...
                  <Input id="email" type="email" value={email} placeholder="Your email"
                ...
                <div className="grid gap-3">
                  ...
                  <Input id="password" type="password" value={password} placeholder="Your password"
                    onChange={(e) => setPassword(e.target.value)} required />
                </div>
                <Button type="button" className="w-full" onClick={handleSignIn}>Sign In</Button>
                <div
